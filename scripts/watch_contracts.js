...
const runMigrate = function () {
  ...
  fsTimeout = setTimeout(function () {
    ...
    // const Migrate = spawn('truffle migrate --reset --compile-all', 
    ...
    // const PID = 1 * Migrate.pid

    require('dc-scripts/src/utils').exitListener(() => {
      console.log('Stop contract watcher...')
