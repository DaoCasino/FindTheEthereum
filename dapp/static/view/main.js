//import daoLang from 'static/lib/daoLang'
...
function loadManifest() {
    ...
    var urlImg = "static/view/img/bg/";
    var urlTexture = "static/view/img/texture/";

    preloader.add("bgMenu", urlImg+"bgMenu.jpg");
    preloader.add("bgGame", urlImg+"bgGame.jpg");
    preloader.add("bgDark", urlImg+"bgDark.png");
    preloader.add("bgWndDeposit", urlImg+"bgWndDeposit.png");
    preloader.add("bgWndInfo", urlImg+"bgWndInfo.png");
    preloader.add("bgWndWarning", urlImg+"bgWndWarning.png");
    preloader.add("bgWndWS", urlImg+"bgWndWS.png");
    preloader.add("bgWndWS1", urlImg+"bgWndWS1.png");
    preloader.add("bgWndBet", urlImg+"bgWndBet.png");

    preloader.add(urlTexture+"BoxesTexture.json");
    preloader.add(urlTexture+"ItemsTexture.json");
...
function getXMLDocument(url) {
    ...
    if (window.XMLHttpRequest) {
        ...
        try {
            xml.send(null);
            console.log("xml:", xml.responseXML);
